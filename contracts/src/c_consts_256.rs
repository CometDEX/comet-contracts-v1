...
pub fn get_min_fee(e: &Env) -> I256 {
    get_bone(e).div(&I256::from_i128(e, 1e6 as i128))
}

// Function to return MAX_FEE constant
pub fn get_max_fee(e: &Env) -> I256 {
...
pub fn get_max_weight(e: &Env) -> I256 {
    get_bone(e).mul(&I256::from_i128(e, 50))
}
...
pub fn get_min_balance(e: &Env) -> I256 {
    get_bone(e).div(&I256::from_i128(e, 1e12 as i128))
}

//================================================================
// Function to return INIT_POOL_SUPPLY constant
pub fn get_init_pool_supply(e: &Env) -> I256 {
    get_bone(e).mul(&I256::from_i128(e, 100))
}
...
pub fn get_max_cpow_base(e: &Env) -> I256 {
    (I256::from_i128(e, 2).mul(&get_bone(e))).sub(&I256::from_i128(e, 1))
}

// Function to return CPOW_PRECISION constant
pub fn get_cpow_precision(e: &Env) -> I256 {
    get_bone(e).div(&I256::from_i128(e, 1e10 as i128))
}
